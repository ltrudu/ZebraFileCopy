...
public class ProfileManagerCommand extends com.zebra.criticalpermissionshelper.CommandBase {
    ...
    public ProfileManagerCommand(Context aContext) {
        super(aContext);
        mSettings = new com.zebra.criticalpermissionshelper.CommandBaseSettings(){{
           mTimeOutMS = 60000;
    ...
    @Override
    protected void onTimeOut(com.zebra.criticalpermissionshelper.CommandBaseSettings settings) {
