...
public class AppRestrictionsChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (APPLICATION_RESTRICTIONS_CHANGED.equals(intent.getAction())) {
            ...
            Bundle managedConfig = myRestrictionsMgr.getApplicationRestrictions();
            logInfo("Managed config:" , managedConfig.toString());
    ...
    private void sendFeedback(Context context, String key, String message) {
